...
class CatalogueMessageServiceTestEvent {
    ...
    void whenProcessMessageReceived() {
        ...
        Message receivedMessage = new MessageStub(messageService, "IN", catalogue, catalogueMessage, header);
        ...
        nl.rhofman.bookstore.persist.model.Message storedMessage = new nl.rhofman.bookstore.persist.model.Message();
        ...
        // Verify
        verify(messageService).saveMessage(anyString());
        verify(messageService).saveMetadata(any(Metadata.class));
