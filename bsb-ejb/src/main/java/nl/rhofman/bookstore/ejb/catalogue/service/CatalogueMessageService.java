...
import nl.rhofman.bookstore.ejb.catalogue.dao.CatalogueMessageBuilder;
import nl.rhofman.bookstore.ejb.message.dao.MessageEventBuilder;
...
public class CatalogueMessageService extends MessageStoreService {
    ...
    @Inject
    private CatalogueMessageBuilder messageBuilder;
    ...
    public void processMessageReceived(String xmlMessage) {
        Message message = messageBuilder.withXml(xmlMessage).build();
...
//        MessageReceived messageReceived = new MessageEventBuilder(header)
